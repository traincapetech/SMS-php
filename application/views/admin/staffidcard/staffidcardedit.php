    ...
    ?>
        ...
        ?>
                                        ...
                                        <div class="fadeheight-sms">
                                         <p class=""> <a class="uploadclosebtn" title="<?php echo $this->lang->line('delete_background_image'); ?>"><i class="fa fa-trash-o" onclick="removebackground_image()"></i></a><?php echo $editstaffidcard[0]->background; ?>
                                         </p>
                                        </div>
                                    </div>
                                        <?php }?>
        ...
        ?>
                                        ...
                                        <div class="fadeheight-sms">
                                         <p class=""> <a class="uploadclosebtn" title="<?php echo $this->lang->line('delete_background_image'); ?>"><i class="fa fa-trash-o" onclick="removelogo_image()"></i></a><?php echo $editstaffidcard[0]->logo; ?>
                                         </p>
                                        </div>
                                    </div>
                                        <?php }?>
        ...
        ?>
                                        ...
                                        <div class="fadeheight-sms">
                                         <p class=""> <a class="uploadclosebtn" title="<?php echo $this->lang->line('delete_sign_image'); ?>"><i class="fa fa-trash-o" onclick="removesign_image()"></i></a><?php echo $editstaffidcard[0]->sign_image; ?>
                                         </p>
                                        </div>
                                    </div>
                                    <?php }?>
