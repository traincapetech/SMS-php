                            ...
                            <div class="table-responsive overflow-visible-lg">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th width="150"><?php echo $this->lang->line('description'); ?></th>
                        ...
                        <div class="mailbox-messages">
                            ...
                            <div class="table-responsive overflow-visible-lg">
                                ...
                                <thead>
                                    <tr>
                                        <th width="5%">#</th>
                                        <th width="10%"><?php echo $this->lang->line('exam'); ?></th>
                                        <th width="5%"><?php echo $this->lang->line('quiz'); ?></th>
                                        <th width="10%"><?php echo $this->lang->line('questions'); ?></th>
                                        <th width="5%"><?php echo $this->lang->line('attempt'); ?></th>
                                        <th width="8%"><?php echo $this->lang->line('exam_from'); ?></th>
                                        <th width="8%"><?php echo $this->lang->line('exam_to') ?></th>
                                        <th width="5%"><?php echo $this->lang->line('duration') ?></th>
                                        <th width="5%"><?php echo $this->lang->line('exam_published'); ?></th>
                                        <th width="5%"><?php echo $this->lang->line('result_published'); ?></th>
                                        <th width="16%"><?php echo $this->lang->line('description'); ?></th>
                                        <th width="23%" class="pull-right noExport"><?php echo $this->lang->line('action'); ?></th>
                                    </tr>
                                </thead>
                               <tbody>
                               </tbody>
