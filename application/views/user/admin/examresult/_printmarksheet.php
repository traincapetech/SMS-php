    ...
    <tbody>
       <tr>
                                                ...
                                                if ($exam->exam_group_type != "gpa") {
                                                    ?>
                                                    <th valign="middle"><?php echo $this->lang->line('max_marks') ?></th>
                                                    <th valign="middle"><?php echo $this->lang->line('min_marks') ?></th>
                                                    <th valign="middle"><?php echo $this->lang->line('marks_obtained') ?></th>
                                                    <?php
